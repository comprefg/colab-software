...
#sudo tmux new-session -d -s my_session 'sudo timeout 30s playit 2>&1 | tail -f /home/pablogod/backup/somefile.txt'
#sudo timeout 10s playit 2>&1 | tee /home/pablogod/backup/somefile.txt
sudo screen -d -m 'sudo timeout 30s playit 2>&1 | tail -f /home/pablogod/backup/somefile.txt'
